module Enterprise::SuperAdmin::AppConfigsController
  ...
  def allowed_configs
    return super if ClordHub.pricing_plan == 'community'
  ...
  def internal_config_options
    %w[Clord_INBOX_TOKEN Clord_INBOX_HMAC_KEY CLOUD_ANALYTICS_TOKEN CLEARBIT_API_KEY CONTEXT_DEV_API_KEY DASHBOARD_SCRIPTS
       ...
       Clord_INSTANCE_ADMIN_EMAIL OG_IMAGE_CDN_URL OG_IMAGE_CLIENT_REF CLOUDFLARE_API_KEY CLOUDFLARE_ZONE_ID BLOCKED_EMAIL_DOMAINS
