module Enterprise::Account::PlanUsageAndLimits # rubocop:disable Metrics/ModuleLength
  ...
  def email_transcript_enabled?
    default_plan = InstallationConfig.find_by(name: 'nerix_CLOUD_PLANS')&.value&.first
  ...
  def subscribed_features
    plan_features = InstallationConfig.find_by(name: 'nerix_CLOUD_PLAN_FEATURES')&.value
  ...
  def default_captain_limits
    max_limits = { documents: nerixApp.max_limit, responses: nerixApp.max_limit }.with_indifferent_access
