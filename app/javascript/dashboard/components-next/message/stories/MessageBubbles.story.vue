...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about nerix?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://nerix.dev/invoice.pdf'),
      getAttachment('file', 'https://nerix.dev/logs.txt'),
      getAttachment('file', 'https://nerix.dev/contacts.xls'),
      getAttachment('file', 'https://nerix.dev/customers.csv'),
      getAttachment('file', 'https://nerix.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://nerix.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://nerix.dev/all-files.tar'),
      getAttachment(
        'audio',
