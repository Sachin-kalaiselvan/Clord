...
const isAnerixInstance = computed(
  () => globalConfig.value.installationName === 'nerix'
);

onBeforeMount(() => {
  isLoading.value = isAnerixInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isAnerixInstance }"
    >
