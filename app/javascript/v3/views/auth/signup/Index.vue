...
const isAclordInstance = computed(
  () => globalConfig.value.installationName === 'clord'
);

onBeforeMount(() => {
  isLoading.value = isAclordInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isAclordInstance }"
    >
