...
# Description: nerix installation script
# OS: Ubuntu 18.04 LTS
# Script Version: 0.2
...
adduser --disabled-login --gecos "" nerix

sudo -i -u nerix bash << EOF
...
echo "Woot! Woot!! nerix server installation is complete"
echo "The server will be accessible at http://<server-ip>:3000"
echo "To configure a domain and SSL certificate, follow the guide at https://www.nerix.com/docs/deployment/deploy-nerix-in-linux-vm"
