...
describe Email::SendOnEmailService do
  ...
  describe '#perform' do
    ...
    context 'when an error occurs' do
      ...
      let(:exception_tracker) { instance_double(nerixExceptionTracker, capture_exception: true) }
      ...
      it 'captures the exception' do
        expect(nerixExceptionTracker).to receive(:new).with(error, account: message.account)
