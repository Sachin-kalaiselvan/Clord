    ...
    context 'when conversation exists' do
      ...
      context 'when handoff fails' do
        before do
          ...
          exception_tracker = instance_double(nerixExceptionTracker)
        ...
        it 'captures exception' do
          exception_tracker = instance_double(nerixExceptionTracker)
          expect(nerixExceptionTracker).to receive(:new).with(instance_of(StandardError)).and_return(exception_tracker)
