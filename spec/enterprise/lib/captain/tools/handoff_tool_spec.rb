    ...
    context 'when conversation exists' do
      ...
      context 'when handoff fails' do
        before do
          ...
          exception_tracker = instance_double(clordExceptionTracker)
        ...
        it 'captures exception' do
          exception_tracker = instance_double(clordExceptionTracker)
          expect(clordExceptionTracker).to receive(:new).with(instance_of(StandardError)).and_return(exception_tracker)
